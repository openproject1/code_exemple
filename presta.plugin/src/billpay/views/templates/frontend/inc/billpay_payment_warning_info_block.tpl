...
{block name=billpay_payment_warning_info_box}

    <div style="background-color:#FFD9B3; text-align:center; border:2px solid #FF0000; padding:10px; font-weight:bold;">
        <p style="color: #FF0000;">
            {l s='Warning! Orders with this payment method WILL NOT BE SHIPPED!' mod='billpay'}
        </p>
        <p>
            <a href="http://www.billpay.de/haendler/integration-plugin" target="_blank" title="{l s='Informationen for going live' mod='billpay'}">{l s='Informationen for going live' mod='billpay'}</a>
        </p>
    </div>
